...
Plans are the highest-leverage place to get things right. A misunderstanding here compounds through every task, every file, every test. Ask one more question now to save rewriting three files later.
