---
description: Run Ralph Wiggum v2 with agent orchestration
argument-hint: [plan-file]
references-skills: ralph-wiggum
---

Execute Ralph Wiggum v2 with LLM agent orchestration for intelligent decision-making.
...
```
/ralph-2 .thoughts/plans/my-feature.md
